...
export const gameContentMap: Record<string, Record<string, TopicContent>> = {
  ...
  italiano: {
    "1-suoni-difficili": {
      ...
      description: "Scegli la combinazione di lettere corretta per completare ogni parola. Esempi: CQU (acqua), GLI (foglia), GN (ragno).",
      gameType: 'timed',
      content: {
        timed: [
          { question: "Completa: a___a (liquido per bere)", options: ["cqu", "cu", "qu"], correct: 0, points: 10, timeLimit: 12 },
          { question: "Completa: fo___a (parte della pianta)", options: ["glia", "lia", "gla"], correct: 0, points: 10, timeLimit: 12 },
          { question: "Completa: ra___o (piccolo animale)", options: ["gno", "nio", "no"], correct: 0, points: 10, timeLimit: 12 },
          { question: "Completa: ma___era (dove dorme il bebè)", options: ["nni", "ni", "gni"], correct: 0, points: 10, timeLimit: 12 },
          { question: "Completa: ba___o (dove fai il bagno)", options: ["gno", "njo", "nio"], correct: 0, points: 10, timeLimit: 12 },
          { question: "Completa: sco___o (parte del corpo)", options: ["gli", "li", "glio"], correct: 0, points: 10, timeLimit: 12 },
          { question: "Completa: a___ila (uccello che vola alto)", options: ["qu", "cu", "cqu"], correct: 0, points: 10, timeLimit: 12 },
          { question: "Completa: so___are (desiderare qualcosa)", options: ["gn", "gni", "ni"], correct: 0, points: 10, timeLimit: 12 },
          { question: "Completa: a___erello (strumento per disegnare)", options: ["cqu", "cu", "qu"], correct: 0, points: 10, timeLimit: 12 },
          { question: "Completa: co___e (animale domestico)", options: ["gni", "ni", "gn"], correct: 0, points: 10, timeLimit: 12 },
          { question: "Completa: mi___are (fare l'occhiolino)", options: ["gn", "ni", "gni"], correct: 0, points: 10, timeLimit: 12 },
          { question: "Completa: mo___e (animale grande)", options: ["gli", "li", "glio"], correct: 0, points: 10, timeLimit: 12 },
          { question: "Completa: su___erire (dare un consiglio)", options: ["gge", "ge", "gg"], correct: 0, points: 10, timeLimit: 12 },
          { question: "Completa: sche___o (disegno veloce)", options: ["zzo", "zo", "tzo"], correct: 0, points: 10, timeLimit: 12 },
          { question: "Completa: fru___o (il rosso delle guance)", options: ["gno", "nio", "no"], correct: 0, points: 10, timeLimit: 12 },
          { question: "Completa: a___isto (che compra)", options: ["cqu", "cu", "qu"], correct: 0, points: 10, timeLimit: 12 },
          { question: "Completa: co___iera (dove si cuoce)", options: ["gli", "li", "glio"], correct: 0, points: 10, timeLimit: 12 },
          { question: "Completa: sve___are (far alzare dal letto)", options: ["gli", "li", "glio"], correct: 0, points: 10, timeLimit: 12 },
          { question: "Completa: compa___a (gruppo di persone)", options: ["gni", "ni", "gn"], correct: 0, points: 10, timeLimit: 12 },
          { question: "Completa: biso___o (avere necessità)", options: ["gno", "nio", "no"], correct: 0, points: 10, timeLimit: 12 },
        ]
      }
    },
    "2-doppie": {
      title: "Ortografia: Le Doppie",
      description: "Abbina ogni parola sbagliata con quella scritta correttamente. Le consonanti doppie cambiano il suono!",
      gameType: 'matching',
      content: {
        matching: [
            { left: "pala", right: "palla", emoji: "⚽", leftEmoji: "❌" },
            { left: "capello", right: "cappello", emoji: "👒", leftEmoji: "❌" },
            { left: "caro", right: "carro", emoji: "🛒", leftEmoji: "❌" },
            { left: "nono", right: "nonno", emoji: "👴", leftEmoji: "❌" },
            { left: "belo", right: "bello", emoji: "😍", leftEmoji: "❌" },
            { left: "casa", right: "cassa", emoji: "📦", leftEmoji: "❌" },
            { left: "nota", right: "notte", emoji: "🌙", leftEmoji: "❌" },
            { left: "sete", right: "sette", emoji: "7️⃣", leftEmoji: "❌" },
            { left: "papa", right: "papà", emoji: "👨", leftEmoji: "❌" },
            { left: "vele", right: "delle", emoji: "⛵", leftEmoji: "❌" },
            { left: "fato", right: "fatto", emoji: "✨", leftEmoji: "❌" },
            { left: "cane", right: "canne", emoji: "🌾", leftEmoji: "❌" },
            { left: "ano", right: "anno", emoji: "📅", leftEmoji: "❌" },
            { left: "baco", right: "bacco", emoji: "🍇", leftEmoji: "❌" },
            { left: "eco", right: "ecco", emoji: "🔊", leftEmoji: "❌" },
        ]
      }
    },
     "3-comprensione": {
      title: "Lettura e Comprensione",
      description: "Leggi attentamente ogni domanda e scegli la risposta corretta. Pensa alle storie che conosci!",
      gameType: 'timed',
      content: {
          timed: [
              { question: "Nella favola della volpe e l'uva, la volpe voleva mangiare...", options: ["il formaggio", "l'uva", "una mela"], correct: 1, points: 10, timeLimit: 20 },
              ...
              { question: "Chi incontra Cappuccetto Rosso nel bosco?", options: ["Il lupo", "Un orso", "Un coniglio"], correct: 0, points: 10, timeLimit: 20 },
              ...
              { question: "Quale casa resiste al lupo cattivo?", options: ["Di paglia", "Di legno", "Di mattoni"], correct: 2, points: 10, timeLimit: 20 },
              { question: "Biancaneve viveva con...", options: ["sei nani", "sette nani", "otto nani"], correct: 1, points: 10, timeLimit: 20 },
              { question: "La matrigna di Biancaneve aveva uno specchio...", options: ["normale", "rotto", "magico"], correct: 2, points: 10, timeLimit: 20 },
              { question: "Cenerentola perdette...", options: ["una scarpina", "un guanto", "una collana"], correct: 0, points: 10, timeLimit: 20 },
              { question: "A mezzanotte Cenerentola doveva...", options: ["dormire", "tornare a casa", "ballare"], correct: 1, points: 10, timeLimit: 20 },
              { question: "Hansel e Gretel trovarono una casa di...", options: ["legno", "pietra", "dolci"], correct: 2, points: 10, timeLimit: 20 },
              { question: "La strega voleva...", options: ["aiutarli", "mangiarli", "adottarli"], correct: 1, points: 10, timeLimit: 20 },
              { question: "Pinocchio era fatto di...", options: ["plastica", "legno", "stoffa"], correct: 1, points: 10, timeLimit: 20 },
              { question: "Quando Pinocchio mentiva, cresceva...", options: ["il naso", "le orecchie", "i capelli"], correct: 0, points: 10, timeLimit: 20 },
          ]
      }
    },
    "4-grammatica": {
